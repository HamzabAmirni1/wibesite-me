...
const projects = [
  ...
  {
    id: 7,
    title: 'محرر السيرة الذاتية – Hamza Amirni CV',
    titleFr: 'Hamza Amirni CV – Éditeur de CV',
    titleEn: 'Hamza Amirni CV – Resume Editor',
    category: 'تطبيق ويب',
    categoryEn: 'Web App',
    categoryFr: 'App Web',
    description: 'محرر سيرة ذاتية ذكي، مجاني ومفتوح المصدر، يحترم الخصوصية دون الحاجة لتسجيل، مع دعم النسخ الاحتياطي وتصدير البيانات.',
    descriptionEn: 'A smart, free, and open-source resume editor designed with privacy first. No registration required, with full backup and data export support.',
    descriptionFr: 'Un éditeur de CV intelligent, gratuit et open source axé sur la confidentialité. Aucune inscription requise, avec sauvegarde et exportation des données.',
    technologies: ['React', 'TypeScript', 'Tailwind', 'Local Storage'],
    liveUrl: 'https://cvhamzaamirni.netlify.app/en',
  ...
  {
    id: 8,
    title: 'حاسبة أسعار البيع الاحترافية',
    titleFr: 'Calculateur de Prix de Vente',
    titleEn: 'Selling Price Calculator',
    category: 'أداة خدماتية',
    categoryEn: 'Utility Tool',
    categoryFr: 'Outil Utilitaire',
    description: 'أداة احترافية لحساب سعر البيع المثالي للمنتجات بدقة مع احتساب التكاليف الإضافية وهامش الربح والرسوم.',
    descriptionEn: 'A professional utility tool to calculate the ideal selling price of products, factoring in additional charges, margin, and fees.',
    descriptionFr: 'Un outil professionnel pour calculer le prix de vente idéal de vos produits, en intégrant les charges supplémentaires, la marge et les taxes.',
    technologies: ['HTML', 'CSS', 'JavaScript'],
    liveUrl: 'https://calculateurdeprix.netlify.app/',
  ...
  {
    id: 9,
    title: 'ZenStep – الصحة النفسية',
    titleFr: 'ZenStep – Bien-être Mental',
    titleEn: 'ZenStep – Mental Wellness',
    category: 'تطبيق صحي',
    categoryEn: 'Wellness App',
    categoryFr: 'App de Bien-être',
    description: 'منصتك اليومية للصحة النفسية وتطوير الذات، تساعدك على محاربة الاكتئاب وبناء عادات صحية من خلال تمارين وألعاب تفاعلية.',
    descriptionEn: 'Your daily mental wellness companion. Combat depression, build healthy habits, and grow through interactive exercises and mini-games.',
    descriptionFr: 'Votre compagnon quotidien de bien-être mental. Combattez la dépression, adoptez des habitudes saines et évoluez grâce à des exercices interactifs.',
    technologies: ['React', 'TypeScript', 'Tailwind', 'Vite'],
    liveUrl: 'https://hamzaamirnizenstep.netlify.app/',
