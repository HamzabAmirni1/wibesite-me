...
const apps = [
  {
    ...
    icon: '📖',
    description: 'تطبيق شامل للقرآن الكريم مع التفسير والترجمة والاستماع بأصوات مشايخ متعددين',
    category: 'إسلامي',
    downloads: '10K+',
    rating: 4.8,
    features: [
      'قراءة القرآن بخط عثماني',
      'تفسير ميسر لجميع الآيات',
      'استماع بأصوات متعددة',
      'حفظ المواضع والإشارات'
    ],
  ...
  },
  {
    ...
    name: 'تعلم البرمجة',
    icon: '💻',
    description: 'منصة تعليمية تفاعلية لتعلم البرمجة من الصفر مع تمارين عملية ومشاريع',
    category: 'تعليمي',
    downloads: '15K+',
    rating: 4.9,
    features: [
