...
const Contact: React.FC = () => {
  ...
  const handleWhatsAppSubmit = () => {
    ...
    const template = t('contactPage.whatsappTemplate', language) as any;
    const text = `
${template.header}
------------------------
${template.name} ${formData.name}
${template.email} ${formData.email}
${template.subject} ${formData.subject}
${template.priority} ${formData.priority}
------------------------
${template.message}
${formData.message}
    `.trim();
  ...
  return (
    ...
    >
      <Card className="text-center bg-gradient-to-br from-primary/5 to-secondary/5 dark:from-primary/10 dark:to-secondary/10 dark:border-white/10">
        <h1 className="text-4xl font-bold text-dark-color dark:text-gray-100 mb-4">{t('contactPage.title', language)}</h1>
        <p className="text-lg text-dark-color/70 dark:text-gray-300">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <Card className="dark:bg-gray-800 dark:border-white/10">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-800 dark:text-gray-200">{t('contactPage.emailLabel', language)}</h3>
                <p className="text-gray-600 dark:text-gray-400">hamzaamirni451@gmail.com</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-800 dark:text-gray-200">{t('contactPage.whatsappLabel', language)}</h3>
                <p className="text-gray-600 dark:text-gray-400">{t('contactPage.whatsappDesc', language)}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-800 dark:text-gray-200">{t('contactPage.locationLabel', language)}</h3>
                <p className="text-gray-600 dark:text-gray-400">{t('contactPage.locationCountry', language)}</p>
              </div>
            </div>
          </div>
        ...
        <Card className="dark:bg-gray-800 dark:border-white/10">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="mb-6 p-4 bg-green-50 dark:bg-green-900/30 rounded-lg border border-green-200 dark:border-green-500/20">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-green-500 text-white px-4 py-2 rounded-lg hover:bg-green-600 transition-colors font-medium shadow-sm hover:shadow-md"
              >
            ...
            <div>
              ...
              <textarea
                ...
                rows={6}
                required
                className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent resize-none"
          ...
          <div className="mt-6 p-4 bg-green-50 dark:bg-green-900/30 rounded-lg border dark:border-green-500/20">
      ...
      <Card className="dark:bg-gray-800 dark:border-white/10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <h3 className="font-semibold text-gray-800 dark:text-gray-100 mb-2">{t('contactPage.faqQ1', language)}</h3>
          ...
          <div>
            <h3 className="font-semibold text-gray-800 dark:text-gray-100 mb-2">{t('contactPage.faqQ2', language)}</h3>
            <p className="text-gray-600 dark:text-gray-400 text-sm">
          ...
          <div>
            <h3 className="font-semibold text-gray-800 dark:text-gray-100 mb-2">{t('contactPage.faqQ3', language)}</h3>
            <p className="text-gray-600 dark:text-gray-400 text-sm">
          ...
          <div>
            <h3 className="font-semibold text-gray-800 dark:text-gray-100 mb-2">{t('contactPage.faqQ4', language)}</h3>
            <p className="text-gray-600 dark:text-gray-400 text-sm">
