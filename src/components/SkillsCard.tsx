...
const SkillItem: React.FC<{ skill: Skill & { translationKey?: string }, index: number }> = ({ skill, index }) => {
        ...
        >
            <div className="flex justify-between items-center">
                <div className="flex items-center gap-2">
                    ...
                    <span className="font-bold text-dark-color dark:text-gray-100">
                        {skill.translationKey ? t(`skillsSection.${skill.translationKey}`, language) : skill.name}
                    </span>
                </div>
