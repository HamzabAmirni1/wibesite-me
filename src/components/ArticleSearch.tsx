...
const ArticleSearch: React.FC<ArticleSearchProps> = ({
  ...
  const defaultPlaceholder = t('articlesPageFull.search.placeholder', language) || 'ابحث في المقالات...';
    ...
    >
      ...
      <AnimatePresence>
        {isFocused && !query && (
          ...
          >
            {t('articlesPageFull.search.hint', language) || '💡 ابحث بالعنوان، الفئة، أو الكلمات المفتاحية'}
          </motion.div>
        )}
      </AnimatePresence>
    </motion.div>
