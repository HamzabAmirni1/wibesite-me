    ...
    return (
        <Card3D className="w-full">
            <Card disableHoverEffect={true} className="text-center bg-gradient-to-br from-primary/5 to-secondary/5 relative overflow-hidden group/card">
                ...
                >
                    <span className="text-6xl font-bold text-primary dark:text-blue-400 select-none" style={{ transform: 'translateZ(20px)' }}>HA</span>
                    {/* Glassmorphic 3D lens highlight overlay */}
                    <div 
                        className="absolute inset-0 bg-gradient-to-tr from-transparent via-white/40 to-transparent dark:via-white/25 opacity-0 group-hover/avatar:opacity-100 transition-opacity duration-300 pointer-events-none" 
                        style={{ transform: 'translateZ(10px)' }} 
                    />
                </motion.div>
                <h1 className="text-4xl font-bold text-dark-color dark:text-gray-100" style={{ transform: 'translateZ(15px)' }}>{t('heroContent.name', language)}</h1>
                <div className="my-4 inline-block" style={{ transform: 'translateZ(15px)' }}>
                ...
                <p className="text-lg leading-relaxed text-dark-color/70 dark:text-gray-300 max-w-3xl mx-auto mt-6" style={{ transform: 'translateZ(10px)' }}>
