...
export const contactPage = {
  ...
  description: {
    ar: 'نحن هنا للإجابة على استفساراتك ومساعدتك في رحلتك التقنية',
    fr: 'Nous sommes là pour répondre à vos questions et vous aider dans votre parcours technologique',
    en: 'We are here to answer your questions and assist you in your tech journey',
  },
  contactInfo: {
    title: {
      ar: 'معلومات التواصل',
    ...
    whatsappDesc: {
      ar: 'متاح من خلال الروابط في الموقع',
      fr: 'Disponible via les liens sur le site',
      en: 'Available through the links on the site',
    },
    location: {
      ar: 'الموقع',
      fr: 'Localisation',
  ...
  socialMedia: {
    title: {
      ar: 'تابعني على وسائل التواصل الاجتماعي',
  ...
  form: {
    ...
    success: {
      ...
      fr: 'Merci ! Votre message a été envoyé avec succès. Nous vous contacterons bientôt.',
