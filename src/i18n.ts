...
export const contactPage = {
  ar: {
    ...
    quickResponseNote: 'للرد السريع: استخدم زر واتساب أعلاه أو راسلنا على: hamzaamirni451@gmail.com أو privacy@hamzaamirni.com',
  ...
  fr: {
    ...
    quickResponseNote: 'Pour une réponse rapide: Utilisez le bouton WhatsApp ci-dessus ou contactez-nous sur: hamzaamirni451@gmail.com ou privacy@hamzaamirni.com',
  ...
  en: {
    ...
    quickResponseNote: 'For quick response: Use the WhatsApp button above or contact us at: hamzaamirni451@gmail.com or privacy@hamzaamirni.com',
