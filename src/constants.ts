...
export const socialLinks = [
  {
    name: "فيسبوك",
    url: "https://www.facebook.com/6kqzuj3y4e",
  ...
  {
    name: "صفحة فيسبوك",
    url: "https://www.facebook.com/profile.php?id=61564527797752",
    IconComponent: SiFacebook,
    color: "bg-[#1877F2]",
    key: "facebookPage",
  },
  {
    name: "يوتيوب",
    url: "https://www.youtube.com/@Hamzaamirni01",
  ...
  {
    name: "إنستجرام 2",
    url: "https://instagram.com/hamza_amirni_02",
    IconComponent: SiInstagram,
    color: "bg-gradient-to-tr from-[#f9ce34] via-[#ee2a7b] to-[#6228d7]",
    key: "instagram2",
  },
  {
    name: "قناة إنستجرام",
    url: "https://www.instagram.com/channel/AbbqrMVbEx_EZLD/",
    IconComponent: SiInstagram,
    color: "bg-gradient-to-tr from-[#f9ce34] via-[#ee2a7b] to-[#6228d7]",
    key: "instagramChannel",
  },
  {
    name: "واتساب",
  ...
  {
    name: "مجموعات واتساب",
    url: "https://chat.whatsapp.com/DDb3fGPuZPB1flLc1BV9gJ",
    IconComponent: SiWhatsapp,
    color: "bg-[#25D366]",
    key: "whatsappGroups",
  },
  ...
  {
    name: "GitHub",
    url: "https://github.com/HamzabAmirni1",
  ...
  {
    name: "LinkedIn",
    url: "https://www.linkedin.com/in/hamza-a-05b639281/",
...
export const myApps = [
  {
    ...
    description:
      "تطبيق إسلامي شامل يحتوي على أذكار يومية وأدعية مأثورة، استغفار وأذكار الصباح والمساء مع نصوص دقيقة وفضائل كل ذكر.",
  ...
  },
  {
    ...
    description:
      "تطبيق تعليمي متقدم يوفر دروس مفصلة وتمارين عملية محلولة لجميع مواد البكالوريا (رياضيات، فيزياء، كيمياء). يتضمن اختبارات تفاعلية وشروح الخطوات.",
...
export const whatsappChannels = [
  ...
  {
    name: "قناة تحديثات البرمجيات",
    url: "https://whatsapp.com/channel/0029ValXRoHCnA7yKopcrn1p",
    IconComponent: SiWhatsapp,
    translationKey: "programmingUpdates",
  },
  {
    name: "قناة تحديثات القرآنيات",
    url: "https://whatsapp.com/channel/0029VaDbxoYJpe8byewMhd3s",
    IconComponent: FaQuran,
    translationKey: "quranUpdates",
  },
  {
    name: "مجموعات واتساب",
    url: "https://chat.whatsapp.com/DDb3fGPuZPB1flLc1BV9gJ",
  ...
  skills: [
    {
      ...
      level: 95,
      icon: Code,
      translationKey: "htmlCssJs",
    },
    {
      name: "PHP, Python",
      level: 90,
      icon: Server,
      translationKey: "phpPython",
    },
    { name: "UI/UX Design", level: 85, icon: Palette, translationKey: "uiUx" },
    {
      name: "Problem Solving",
      level: 92,
      icon: BrainCircuit,
      translationKey: "problemSolving",
    },
    {
      name: "Hardware & Software",
      level: 88,
      icon: Cpu,
      translationKey: "hardwareSoftware",
    },
  ],
  journey: [
    "حاصل على شهادة البكالوريا في العلوم الفيزيائية (PC) سنة 2023.",
    "أكملت السنة الأولى في شعبة رسم البناء (Dessin de Bâtiment).",
    "أتابع حالياً دراستي في شعبة التطوير الرقمي بـ OFPPT.",
    "متخصص في برمجة البوتات وتطوير تطبيقات الويب والحلول الذكية.",
  ],
  philosophy: {
    title: "🎯 فلسفتي",
    points: [
      {
        ...
        description:
          "أؤمن بأن التعليم المستمر يدفعك للأمام والمعرفة تزداد كلما تعلمت أكثر.",
      },
      {
        icon: CheckCircle,
        title: "تقديم الجودة",
...
export const programmingContent = {
  ...
  description:
    "البرمجة هي فن وعلم كتابة الأوامر والتعليمات وتحويلها إلى لغة يفهمها الحاسوب. والبرمجة هي من أهم المجالات في العصر الحالي. 👍",
  fullContent: `
...
export const funContent = {
  title: "🎮 ألعاب ممتعة",
  description:
    "ما الألعاب التي تحب لعبها في وقت فراغك؟ قم بتجربة هذه الألعاب الرائعة والممتعة!",
  games: [
    {
      title: "ألعاب رياضيات",
...
export const botsContent = {
  ...
  bots: [
    {
      title: "بوت تحديث البرمجيات",
      description: "تحديث معلومات سريعة للبوت في تحديث البرمجيات",
      url: "https://wa.me/212708869993",
      buttonText: "تحديث",
      IconComponent: SiWhatsapp,
      color: "success",
    },
    {
      title: "ChatGPT Bot",
      description: "استخدام بوت ChatGPT لحل أسئلة ومشاكل",
      url: "https://wa.me/18002428478",
      buttonText: "نتحدث",
    ...
    {
      title: "Copilot Bot",
      description: "مساعد برمجي ذكي لمساعدتك في مشاريع البرمجة",
      url: "https://wa.me/18772241042",
      buttonText: "نتحدث",
      IconComponent: SiGithubcopilot,
      color: "warning",
    },
    {
      title: "Perplexity Bot",
      description: "محرك بحث ذكي لمساعدتك على الحصول على المعلومات",
      url: "https://wa.me/18334363285",
      buttonText: "نتحدث",
      IconComponent: SiPerplexity,
      color: "danger",
    },
    {
      title: "بوت فيسبوك الذكي",
      description: "بوت متخصص على منصة فيسبوك لتقديم خدمات ذكية وتواصل سريع",
    ...
    {
      title: "بوت واتساب (رقم 2)",
      description: "تواصل مباشر للحصول على المساعدة التقنية والبرمجية",
      url: "https://wa.me/212631342792",
      buttonText: "نتحدث",
      IconComponent: SiWhatsapp,
      color: "success",
    },
    {
      title: "بوت واتساب (رقم 3)",
      description: "مساعد تقني إضافي للرد على استفساراتكم وتطوير مشاريعكم",
      url: "https://wa.me/212649550748",
      buttonText: "نتحدث",
      IconComponent: SiWhatsapp,
      color: "success",
    },
    {
      title: "بوت واتساب (رقم 4)",
      description: "قناة تواصل فعالة للحصول على أفضل الخدمات التقنية",
      url: "https://wa.me/212656918407",
      buttonText: "نتحدث",
      IconComponent: SiWhatsapp,
      color: "success",
    },
...
export const toolsContent = {
  title: "🛠️ أدوات مفيدة",
  description:
    "استخدم مجموعة من أدوات الويب والتطبيقات المفيدة في حياتك اليومية.",
  tools: [
    {
      title: "Google Docs",
      description: "محرر مستندات متقدم من جوجل",
      url: "https://docs.google.com/",
      IconComponent: SiGoogledocs,
      tags: ["محررات", "مستندات"],
    },
    {
      title: "ChatGPT",
      description: "مساعد ذكي للإجابة على الأسئلة",
      url: "https://chat.openai.com/",
      IconComponent: SiOpenai,
      tags: ["ذكاء اصطناعي", "مساعد"],
    },
    {
      title: "Coursera",
      description: "منصة تعليمية من جامعات عالمية",
      url: "https://www.coursera.org/",
      IconComponent: SiCoursera,
      tags: ["منصات", "تعليم"],
    },
    {
      title: "Canva",
      description: "برنامج تصميم سهل وسريع",
    ...
    {
      title: "GitHub",
      description: "منصة مشهورة لمشاركة البرمجيات",
    ...
    },
    {
      ...
      description: "موقع رائع للأسئلة والإجابات على مشاكل البرمجة",
      url: "https://stackoverflow.com/",
      IconComponent: SiStackoverflow,
      tags: ["برمجة", "أسئلة"],
    },
  ],
};
...
export const articlesContent = {
  ...
  description:
    "في هذا القسم نناقش مجموعة من المقالات المهمة والتقنيات والبرمجيات والتطبيقات.",
  articles: [
    {
      id: "web-design-tips",
      ...
      summary:
        "اكتشف أحدث اتجاهات تصميم الويب وكيفية تطبيقها لإنشاء مواقع احترافية وجذابة.",
      author: "حمزة اعمرني",
      date: "10 نوفمبر 2025",
      color: "warning",
      image:
    ...
    },
    {
      ...
      summary:
        "تعلم استراتيجيات إنتاجية مثبتة ستجعلك تنجز أكثر في وقت أقل وبجودة عالية.",
      author: "حمزة اعمرني",
      date: "5 نوفمبر 2025",
      color: "info",
      image:
    ...
    },
    {
      ...
      summary:
        "تعرف على فضائل الأذكار والاستغفار وكيف تؤثر على روحك وصحتك النفسية والجسدية.",
      author: "حمزة اعمرني",
      date: "1 نوفمبر 2025",
      color: "success",
      image:
    ...
    },
    {
      ...
      summary:
        "ستجد هنا الحل الكامل والمفصّل لفتح واتساب من خلال طرق سهلة وموثوقة وآمنة جداً.",
      author: "حمزة اعمرني",
      date: "28 نوفمبر 2025",
      color: "success",
      image:
    ...
    },
    {
      ...
      summary:
        "دليل كامل يأخذك من الصفر إلى أول برنامج عملي. تعلم البرمجة لم تكن بهذه البساطة من قبل.",
      author: "حمزة اعمرني",
      date: "15 نوفمبر 2025",
      color: "primary",
      image:
...
console.log(greet("أحمد"));  // مرحباً أحمد</pre><h2>اختيار لغة البرمجة الأولى</h2><h3>JavaScript - الخيار الأول للمبتدئين</h3><p>هذه هي أسهل لغة للبدء. تعمل في المتصفح مباشرة. يمكنك رؤية النتائج فوراً.</p><h3>Python - إذا أردت شيئاً أكثر سهولة</h3><p>Python تتمتع بجملة واضحة جداً وسهلة الفهم. رائعة للمبتدئين.</p><h2>خطوات البدء العملية</h2><ol class="list-decimal list-inside"><li><strong>اختر لغة واحدة:</strong> JavaScript أو Python</li><li><strong>جهز بيئة التطوير:</strong> حمّل VS Code (مجاني)</li><li><strong>تعلم المفاهيم الأساسية:</strong> متغيرات، شروط، حلقات، دوال</li><li><strong>مارس كل يوم:</strong> اكتب كود كل يوم، حتى لو 30 دقيقة</li><li><strong>ابني مشاريع صغيرة:</strong> آلة حاسبة، لعبة بسيطة، موقع ويب</li><li><strong>تعمق وتخصص:</strong> بعد 3-6 أشهر، اختر مجالاً (ويب، ألعاب، ذكاء اصطناعي)</li></ol><h2>موارد التعلم المجانية</h2><ul class="list-disc list-inside"><li><strong>YouTube:</strong> قنوات مثل "Traversy Media" و "freeCodeCamp"</li><li><strong>Codecademy:</strong> تعلم تفاعلي</li><li><strong>freeCodeCamp.org:</strong> دورات مجانية شاملة</li><li><strong>MDN Web Docs:</strong> توثيق ممتاز</li><li><strong>LeetCode:</strong> لحل مسائل برمجية</li></ul><h2>الأخطاء الشائعة التي يجب تجنبها</h2><ul class="list-disc list-inside"><li>عدم الممارسة المنتظمة - الممارسة هي كل شيء</li><li>اختيار لغات صعبة جداً في البداية</li><li>الاستسلام عند أول صعوبة - كل الأخطاء طبيعية</li><li>عدم حل مشاكل بنفسك - جرب قبل أن تبحث عن الحل</li><li>تعلم كل الأشياء دفعة واحدة - تعلم تدريجياً</li></ul><h2>الخاتمة</h2><p>البرمجة مهارة تُتعلم بالممارسة والصبر. كل مبرمج عظيم بدأ من الصفر. ابدأ اليوم، اكتب أول سطر كود، والباقي سيأتي بسهولة.</p>`,
    },
    {
      ...
      summary:
        "اتقن المفاهيم المتقدمة في JavaScript التي ستحسن مهارات البرمجة لديك بشكل كبير.",
      author: "حمزة اعمرني",
      date: "20 نوفمبر 2025",
      color: "warning",
      image:
...
export const chatContent = {
  ...
  description:
    "يمكنك التواصل معي من خلال الوسائل التالية، أو قم بملء نموذج الاتصال بسهولة.",
  methods: [
    {
      IconComponent: SiWhatsapp,
      title: "واتساب مباشر",
      description: "تحديث معي على واتساب للتحدث المباشر",
      url: "https://wa.me/+212624855939",
      buttonText: "واتساب",
      color: "success",
    },
    {
      IconComponent: SiFacebook,
      title: "فيسبوك",
      description: "تحديث معك على فيسبوك",
      url: "https://www.facebook.com/6kqzuj3y4e",
      buttonText: "فيسبوك",
      color: "primary",
    },
    {
      IconComponent: SiInstagram,
      title: "إنستجرام",
      description: "متابعة وتحديث معك على إنستجرام",
      url: "https://instagram.com/hamza_amirni_01",
      buttonText: "إنستجرام",
      color: "danger",
    },
    {
      IconComponent: SiTelegram,
      title: "تيليجرام مباشر",
      description: "تحديث معك على تيليجرام للتحدث المباشر",
      url: "https://t.me/hamzaamirni",
      buttonText: "تيليجرام",
      color: "primary",
    },
