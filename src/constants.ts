...
export const socialLinks = [
    { name: 'فيسبوك', url: 'https://www.facebook.com/6kqzuj3y4e', IconComponent: SiFacebook, color: 'bg-[#1877F2]', key: 'facebook' },
    { name: 'صفحة فيسبوك', url: 'https://www.facebook.com/profile.php?id=61564527797752', IconComponent: SiFacebook, color: 'bg-[#1877F2]', key: 'facebookPage' },
    { name: 'يوتيوب', url: 'https://www.youtube.com/@Hamzaamirni01', IconComponent: SiYoutube, color: 'bg-[#FF0000]', key: 'youtube' },
    { name: 'إنستجرام', url: 'https://instagram.com/hamza_amirni_01', IconComponent: SiInstagram, color: 'bg-gradient-to-tr from-[#f9ce34] via-[#ee2a7b] to-[#6228d7]', key: 'instagram' },
    { name: 'إنستجرام 2', url: 'https://instagram.com/hamza_amirni_02', IconComponent: SiInstagram, color: 'bg-gradient-to-tr from-[#f9ce34] via-[#ee2a7b] to-[#6228d7]', key: 'instagram2' },
    { name: 'قناة إنستجرام', url: 'https://www.instagram.com/channel/AbbqrMVbEx_EZLD/', IconComponent: SiInstagram, color: 'bg-gradient-to-tr from-[#f9ce34] via-[#ee2a7b] to-[#6228d7]', key: 'instagramChannel' },
    { name: 'واتساب', url: 'https://wa.me/+212624855939', IconComponent: SiWhatsapp, color: 'bg-[#25D366]', key: 'whatsapp' },
...
export const whatsappChannels = [
    { name: 'تواصل معي مباشرة', url: 'https://api.whatsapp.com/send/?phone=212708869993&text&type=phone_number&app_absent=0', IconComponent: SiWhatsapp, translationKey: 'directContact' },
    { name: 'قناة تحديثات البرمجيات', url: 'https://whatsapp.com/channel/0029ValXRoHCnA7yKopcrn1p', IconComponent: SiWhatsapp, translationKey: 'programmingUpdates' },
    { name: 'قناة تحديثات القرآنيات', url: 'https://whatsapp.com/channel/0029VaDbxoYJpe8byewMhd3s', IconComponent: FaQuran, translationKey: 'quranUpdates' },
    { name: 'مجموعات واتساب', url: 'https://chat.whatsapp.com/DDb3fGPuZPB1flLc1BV9gJ', IconComponent: SiWhatsapp, translationKey: 'whatsappGroups' },
];
...
export const aboutContent = {
    ...
    description: `
        ...
        `,
    skills: [
        { name: 'HTML, CSS, JS', level: 95, icon: Code, translationKey: 'htmlCssJs' },
        { name: 'PHP, Python', level: 90, icon: Server, translationKey: 'phpPython' },
        { name: 'UI/UX Design', level: 85, icon: Palette, translationKey: 'uiUx' },
        { name: 'Problem Solving', level: 92, icon: BrainCircuit, translationKey: 'problemSolving' },
        { name: 'Hardware & Software', level: 88, icon: Cpu, translationKey: 'hardwareSoftware' },
    ],
    journey: [
